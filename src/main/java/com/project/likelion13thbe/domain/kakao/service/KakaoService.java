package com.project.likelion13thbe.domain.kakao.service;


import com.project.likelion13thbe.domain.kakao.dto.response.KakaoTokenResponseDTO;
...
public class KakaoService {
    ...
    public String getAccessTokenFromKakao(String code) {
        ...
        KakaoTokenResponseDTO kakaoTokenResponseDto = WebClient.create(tokenURI)
                ...
                .onStatus(HttpStatusCode::is4xxClientError, clientResponse -> Mono.error(new RuntimeException(clientResponse.toString())))

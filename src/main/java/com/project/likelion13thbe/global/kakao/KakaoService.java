...
public class KakaoService {
    ...
    public String login(String kakaoEmail, String kakaoEncodedPassword){
        ...
        JwtDTO.JwtLoginResDTO jwtLoginResDTO = JwtDTO.JwtLoginResDTO.builder()
        ...
        CustomResponse<JwtDTO.JwtLoginResDTO> responseBody = CustomResponse.onSuccess(jwtLoginResDTO);
        return null;
    }

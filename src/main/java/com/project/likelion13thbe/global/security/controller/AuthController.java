...
public class AuthController {
    ...
    @PostMapping("/reissue")
    public CustomResponse<?> reissue(@RequestBody JwtDTO.JwtResDTO jwtResDTO) throws SignatureException {

        log.info("[ Auth Controller ] 토큰을 재발급합니다. ");

        return CustomResponse.onSuccess(authService.reissueToken(jwtResDTO));
    }
}
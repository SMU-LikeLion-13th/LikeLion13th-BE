...
import com.project.likelion13thbe.global.error.AuthException;
...
public class CustomLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(
        ...
        TokenDTO jwtDto = TokenDTO.builder()
        ...
        CustomResponse<TokenDTO> responseBody = CustomResponse.onSuccess(jwtDto);
    ...
    protected void unsuccessfulAuthentication(
        ...
        // CustomResponse 사용하여 응답 통일
        CustomResponse<TokenDTO> responseBody = CustomResponse.onFailure(errorCode, errorMessage);

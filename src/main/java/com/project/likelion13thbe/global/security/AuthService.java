...
import com.project.likelion13thbe.global.error.AuthErrorCode;
import com.project.likelion13thbe.global.token.dto.TokenDTO;
import com.project.likelion13thbe.global.token.entity.Token;
import com.project.likelion13thbe.global.token.repository.TokenRepository;
...
public class AuthService {
    ...
    public TokenDTO reissueToken(TokenDTO jwtDto) throws AuthException {
        ...
        Token refreshTokenByDB = tokenRepository.findByEmail(email).orElseThrow(
                () -> new AuthException(AuthErrorCode.INVALID_TOKEN.getMessage())
        );
        ...
        if (refreshTokenByDB.getToken().equals(refreshToken)) {
            ...
            throw new AuthException(AuthErrorCode.INVALID_TOKEN.getMessage());
        }
    }
}

...
public class CustomLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        MemberRequestDTO.LoginRequestDTO requestBody;
        try {
            requestBody = objectMapper.readValue(request.getInputStream(), MemberRequestDTO.LoginRequestDTO.class);
        ...
        // authenticationManager에게 전달하며 인증 시도
    ...
    protected void successfulAuthentication(
            ...
            @NonNull Authentication authentication) throws IOException, java.io.IOException {

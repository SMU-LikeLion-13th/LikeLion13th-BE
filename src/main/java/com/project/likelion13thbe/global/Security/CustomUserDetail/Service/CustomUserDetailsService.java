package com.project.likelion13thbe.global.Security.CustomUserDetail.Service;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        // Email에 해당하는 유저를 DB에서 찾고 UserDetails로 반환
        ...
        if (memberEntity.isPresent()) {
            ...
            return new CustomUserDetails(member.getEmail(),member.getPassword(), member.getRole().toString());
        }
